...
{
    /// <inheritdoc />
    public partial class ModifiedVwProductivityWithDowntime : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            string sqlSentence = @"ALTER VIEW [dbo].[vwProductivityWithDowntime]
                AS                
                SELECT 
                    pro.Date,
                    l.Name,
                ...
                WHERE l.Flow = 2
                GO";
            migrationBuilder.Sql(sqlSentence);
        }
