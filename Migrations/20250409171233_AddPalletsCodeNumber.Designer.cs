...
namespace Inventio.Migrations
{
    ...
    [Migration("20250409171233_AddPalletsCodeNumber")]
    partial class AddPalletsCodeNumber
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Inventio.Models.Notifications.NotificationEventLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("NotificationEventLog");
                });

            modelBuilder.Entity("Inventio.Models.Notifications.NotificationInventory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("NotificationInventory");
                });

            modelBuilder.Entity("Inventio.Models.Notifications.NotificationMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Inventio.Models.Notifications.NotificationTemplate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Inventio.Models.QualityIncident", b =>
                {
                    ...
                    b.Property<DateTime>("AuditDateUpdated")
                        .HasColumnType("datetime2");

                    b.Property<string>("AuditUpdatedById")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<string>("PalletsCodeNumber")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("AuditCreatedById");

                    b.HasIndex("AuditUpdatedById");
            ...
            modelBuilder.Entity("Inventio.Models.Notifications.NotificationInventory", b =>
                {
                    b.HasOne("Inventio.Models.Notifications.NotificationTemplate", "NotificationTemplate")
                        .WithMany()
            ...
            modelBuilder.Entity("Inventio.Models.Notifications.NotificationMessage", b =>
                {
                    b.HasOne("Inventio.Models.User", "MessageTo")
                        .WithMany()
            ...
            modelBuilder.Entity("Inventio.Models.QualityIncident", b =>
                {
                    b.HasOne("Inventio.Models.User", "AuditCreatedBy")
                        .WithMany()
                        .HasForeignKey("AuditCreatedById")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Inventio.Models.User", "AuditUpdatedBy")
                        .WithMany()
                        .HasForeignKey("AuditUpdatedById")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
